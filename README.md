...
![img.png](img.png) - Person osztaly nevene kis betuvel irasa
...
![img_1.png](img_1.png)
miutan kijavitottam a dolgokat: - A SimulationTime osztalyban a NextMillisec es a konstruktorok nem voltak lefedve (32,8%), de uj tesztek hozzaadva a lefedettseg 42,5%-ra javult.
![img_2.png](img_2.png)
...
![img_4.png](img_4.png)
Javitott hiba: Unexpected var, use let or const instead - bouncing.js
